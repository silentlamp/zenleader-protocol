...
func (x CloudRecordingVariants) Enum() *CloudRecordingVariants {
	p := new(CloudRecordingVariants)
	*p = x
	return p
}
...
func (CloudRecordingVariants) Descriptor() protoreflect.EnumDescriptor {
	return file_plugnmeet_recorder_proto_enumTypes[2].Descriptor()
}

func (CloudRecordingVariants) Type() protoreflect.EnumType {
	return &file_plugnmeet_recorder_proto_enumTypes[2]
}

func (x CloudRecordingVariants) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
type RecorderToPlugNmeet struct {
	...
	RecordingVariant *CloudRecordingVariants `protobuf:"varint,12,opt,name=recording_variant,json=recordingVariant,proto3,enum=plugnmeet.CloudRecordingVariants,oneof" json:"recording_variant,omitempty"` // next key 13
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
