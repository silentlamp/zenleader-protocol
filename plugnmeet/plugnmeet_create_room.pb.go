...
type RoomCreateFeatures struct {
	...
	AllowRtmp                    *bool                         `protobuf:"varint,4,opt,name=allow_rtmp,json=allowRtmp,proto3,oneof" json:"allow_rtmp,omitempty"`
	...
	RoomDuration                 *uint64                       `protobuf:"varint,8,opt,name=room_duration,json=roomDuration,proto3,oneof" json:"room_duration,omitempty"`
	...
	SharedNotePadFeatures        *SharedNotePadFeatures        `protobuf:"bytes,15,opt,name=shared_note_pad_features,json=sharedNotePadFeatures,proto3" json:"shared_note_pad_features,omitempty"`
	WhiteboardFeatures           *WhiteboardFeatures           `protobuf:"bytes,16,opt,name=whiteboard_features,json=whiteboardFeatures,proto3" json:"whiteboard_features,omitempty"`
	ExternalMediaPlayerFeatures  *ExternalMediaPlayerFeatures  `protobuf:"bytes,17,opt,name=external_media_player_features,json=externalMediaPlayerFeatures,proto3" json:"external_media_player_features,omitempty"`
	WaitingRoomFeatures          *WaitingRoomFeatures          `protobuf:"bytes,18,opt,name=waiting_room_features,json=waitingRoomFeatures,proto3" json:"waiting_room_features,omitempty"`
	BreakoutRoomFeatures         *BreakoutRoomFeatures         `protobuf:"bytes,19,opt,name=breakout_room_features,json=breakoutRoomFeatures,proto3" json:"breakout_room_features,omitempty"`
	DisplayExternalLinkFeatures  *DisplayExternalLinkFeatures  `protobuf:"bytes,20,opt,name=display_external_link_features,json=displayExternalLinkFeatures,proto3" json:"display_external_link_features,omitempty"`
	IngressFeatures              *IngressFeatures              `protobuf:"bytes,21,opt,name=ingress_features,json=ingressFeatures,proto3" json:"ingress_features,omitempty"`
	EndToEndEncryptionFeatures   *EndToEndEncryptionFeatures   `protobuf:"bytes,22,opt,name=end_to_end_encryption_features,json=endToEndEncryptionFeatures,proto3" json:"end_to_end_encryption_features,omitempty"`
...
func (x *RoomCreateFeatures) GetExternalBroadcastingFeatures() *ExternalBroadcastingFeatures {
	if x != nil {
		return x.ExternalBroadcastingFeatures
	}
	return nil
}
...
type ChatFeatures struct {
	...
	IsAllowFileUpload bool                   `protobuf:"varint,2,opt,name=is_allow_file_upload,json=isAllowFileUpload,proto3" json:"is_allow_file_upload,omitempty"`
...
type ExternalBroadcastingFeatures struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	IsAllow            bool                   `protobuf:"varint,1,opt,name=is_allow,json=isAllow,proto3" json:"is_allow,omitempty"`
	IsAllowRtmp        bool                   `protobuf:"varint,2,opt,name=is_allow_rtmp,json=isAllowRtmp,proto3" json:"is_allow_rtmp,omitempty"`
	RecorderBotOptions *RecorderBotOptions    `protobuf:"bytes,3,opt,name=recorder_bot_options,json=recorderBotOptions,proto3,oneof" json:"recorder_bot_options,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *ExternalBroadcastingFeatures) Reset() {
	*x = ExternalBroadcastingFeatures{}
	mi := &file_plugnmeet_create_room_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ExternalBroadcastingFeatures) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExternalBroadcastingFeatures) ProtoMessage() {}

func (x *ExternalBroadcastingFeatures) ProtoReflect() protoreflect.Message {
	mi := &file_plugnmeet_create_room_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExternalBroadcastingFeatures.ProtoReflect.Descriptor instead.
func (*ExternalBroadcastingFeatures) Descriptor() ([]byte, []int) {
	return file_plugnmeet_create_room_proto_rawDescGZIP(), []int{10}
}

func (x *ExternalBroadcastingFeatures) GetIsAllow() bool {
	if x != nil {
		return x.IsAllow
	}
	return false
...
func (x *ExternalBroadcastingFeatures) GetIsAllowRtmp() bool {
	if x != nil {
		return x.IsAllowRtmp
	}
	return false
}

func (x *ExternalBroadcastingFeatures) GetRecorderBotOptions() *RecorderBotOptions {
	if x != nil {
...
type RecordingFeatures struct {
	...
	RecorderBotOptions       *RecorderBotOptions    `protobuf:"bytes,6,opt,name=recorder_bot_options,json=recorderBotOptions,proto3,oneof" json:"recorder_bot_options,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *RecordingFeatures) GetRecorderBotOptions() *RecorderBotOptions {
	if x != nil {
		return x.RecorderBotOptions
	}
	return nil
...
const file_plugnmeet_create_room_proto_rawDesc = "" +
	"\n" +
	"\x1bplugnmeet_create_room.proto\x12\tplugnmeet\x1a\x19plugnmeet_gen_token.proto\x1a\x1bbuf/validate/validate.proto\x1a\x17plugnmeet_ingress.proto\x1a\x19plugnmeet_auth_room.proto\x1a\x1aplugnmeet_common_api.proto\x1a\x19plugnmeet_recording.proto\"\xfd\x02\n" +
	...
	"\x12allow_screen_share\x18\x03 \x01(\bR\x10allowScreenShare\x12&\n" +
	"\n" +
	"allow_rtmp\x18\x04 \x01(\bB\x02\x18\x01H\x00R\tallowRtmp\x88\x01\x01\x127\n" +
	...
	"\rroom_duration\x18\b \x01(\x04H\x01R\froomDuration\x88\x01\x01\x12)\n" +
	"\x10enable_analytics\x18\t \x01(\bR\x0fenableAnalytics\x12-\n" +
	...
	"\x13whiteboard_features\x18\x10 \x01(\v2\x1d.plugnmeet.WhiteboardFeaturesR\x12whiteboardFeatures\x12k\n" +
	"\x1eexternal_media_player_features\x18\x11 \x01(\v2&.plugnmeet.ExternalMediaPlayerFeaturesR\x1bexternalMediaPlayerFeatures\x12R\n" +
	"\x15waiting_room_features\x18\x12 \x01(\v2\x1e.plugnmeet.WaitingRoomFeaturesR\x13waitingRoomFeatures\x12U\n" +
	"\x16breakout_room_features\x18\x13 \x01(\v2\x1f.plugnmeet.BreakoutRoomFeaturesR\x14breakoutRoomFeatures\x12k\n" +
	"\x1edisplay_external_link_features\x18\x14 \x01(\v2&.plugnmeet.DisplayExternalLinkFeaturesR\x1bdisplayExternalLinkFeatures\x12E\n" +
	"\x10ingress_features\x18\x15 \x01(\v2\x1a.plugnmeet.IngressFeaturesR\x0fingressFeatures\x12i\n" +
	"\x1eend_to_end_encryption_features\x18\x16 \x01(\v2%.plugnmeet.EndToEndEncryptionFeaturesR\x1aendToEndEncryptionFeatures\x12?\n" +
	"\x0epolls_features\x18\x17 \x01(\v2\x18.plugnmeet.PollsFeaturesR\rpollsFeatures\x12H\n" +
	"\x11insights_features\x18\x18 \x01(\v2\x1b.plugnmeet.InsightsFeaturesR\x10insightsFeatures\x12M\n" +
	"\x14sip_dial_in_features\x18\x19 \x01(\v2\x1c.plugnmeet.SipDialInFeaturesR\x11sipDialInFeatures\x12m\n" +
	"\x1eexternal_broadcasting_features\x18\x1a \x01(\v2'.plugnmeet.ExternalBroadcastingFeaturesR\x1cexternalBroadcastingFeaturesB\r\n" +
	"\v_allow_rtmpB\x10\n" +
	...
	"\x14is_allow_file_upload\x18\x02 \x01(\bR\x11isAllowFileUpload\x12,\n" +
	...
	"\x0e_max_file_size\"\xce\x04\n" +
	"\x15SharedNotePadFeatures\x12\x19\n" +
	"\bis_allow\x18\x01 \x01(\bR\aisAllow\x12$\n" +
	...
	"\x17read_only_pad_id_format\x12-read_only_pad_id should not contain any value\x1a\x12this.matches('^$')R\rreadOnlyPadId\"\x8e\x05\n" +
	"\x12WhiteboardFeatures\x12\x19\n" +
	"\bis_allow\x18\x01 \x01(\bR\aisAllow\x12!\n" +
	...
	"\r_preload_fileB\x18\n" +
	"\x16_max_allowed_file_size\"\xcd\x02\n" +
	"\x1bExternalMediaPlayerFeatures\x12\x19\n" +
	"\bis_allow\x18\x01 \x01(\bR\aisAllow\x12$\n" +
	...
	"\n" +
	"_shared_by\"\xcc\x01\n" +
	"\x1cExternalBroadcastingFeatures\x12\x19\n" +
	"\bis_allow\x18\x01 \x01(\bR\aisAllow\x12\"\n" +
	"\ris_allow_rtmp\x18\x02 \x01(\bR\visAllowRtmp\x12T\n" +
	"\x14recorder_bot_options\x18\x03 \x01(\v2\x1d.plugnmeet.RecorderBotOptionsH\x00R\x12recorderBotOptions\x88\x01\x01B\x17\n" +
	"\x15_recorder_bot_options\"\xe3\x02\n" +
	...
	"\x19only_record_admin_webcams\x18\x05 \x01(\bR\x16onlyRecordAdminWebcams\x12T\n" +
	"\x14recorder_bot_options\x18\x06 \x01(\v2\x1d.plugnmeet.RecorderBotOptionsH\x00R\x12recorderBotOptions\x88\x01\x01B\x17\n" +
	"\x15_recorder_bot_options\"\xb7\x02\n" +
...
var file_plugnmeet_create_room_proto_goTypes = []any{
	...
	(*ExternalBroadcastingFeatures)(nil),           // 10: plugnmeet.ExternalBroadcastingFeatures
	(*RecordingFeatures)(nil),                      // 11: plugnmeet.RecordingFeatures
	(*IngressFeatures)(nil),                        // 12: plugnmeet.IngressFeatures
	...
	(*RecorderBotOptions)(nil),                     // 26: plugnmeet.RecorderBotOptions
	(IngressInput)(0),                              // 27: plugnmeet.IngressInput
	(StatusCode)(0),                                // 28: plugnmeet.StatusCode
	(*ActiveRoomInfo)(nil),                         // 29: plugnmeet.ActiveRoomInfo
}
var file_plugnmeet_create_room_proto_depIdxs = []int32{
	...
	11, // 5: plugnmeet.RoomCreateFeatures.recording_features:type_name -> plugnmeet.RecordingFeatures
	...
	12, // 13: plugnmeet.RoomCreateFeatures.ingress_features:type_name -> plugnmeet.IngressFeatures
	...
	16, // 16: plugnmeet.RoomCreateFeatures.insights_features:type_name -> plugnmeet.InsightsFeatures
	15, // 17: plugnmeet.RoomCreateFeatures.sip_dial_in_features:type_name -> plugnmeet.SipDialInFeatures
	10, // 18: plugnmeet.RoomCreateFeatures.external_broadcasting_features:type_name -> plugnmeet.ExternalBroadcastingFeatures
	26, // 19: plugnmeet.ExternalBroadcastingFeatures.recorder_bot_options:type_name -> plugnmeet.RecorderBotOptions
	26, // 20: plugnmeet.RecordingFeatures.recorder_bot_options:type_name -> plugnmeet.RecorderBotOptions
	27, // 21: plugnmeet.IngressFeatures.input_type:type_name -> plugnmeet.IngressInput
	17, // 22: plugnmeet.InsightsFeatures.transcription_features:type_name -> plugnmeet.InsightsTranscriptionFeatures
	18, // 23: plugnmeet.InsightsFeatures.chat_translation_features:type_name -> plugnmeet.InsightsChatTranslationFeatures
	19, // 24: plugnmeet.InsightsFeatures.ai_features:type_name -> plugnmeet.InsightsAIFeatures
	20, // 25: plugnmeet.InsightsAIFeatures.ai_text_chat_features:type_name -> plugnmeet.InsightsAITextChatFeatures
	21, // 26: plugnmeet.InsightsAIFeatures.meeting_summarization_features:type_name -> plugnmeet.InsightsAIMeetingSummarizationFeatures
	28, // 27: plugnmeet.CreateRoomRes.status_code:type_name -> plugnmeet.StatusCode
	29, // 28: plugnmeet.CreateRoomRes.room_info:type_name -> plugnmeet.ActiveRoomInfo
...
func file_plugnmeet_create_room_proto_init() {
	...
	file_plugnmeet_create_room_proto_msgTypes[10].OneofWrappers = []any{}
	file_plugnmeet_create_room_proto_msgTypes[11].OneofWrappers = []any{}
