...
type MergeRecordingsByIds struct {
	...
	RecordingIds  []string `protobuf:"bytes,2,rep,name=recording_ids,json=recordingIds,proto3" json:"recording_ids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MergeRecordingsReq struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to MergeScope:
	//
	//	*MergeRecordingsReq_BySession
	//	*MergeRecordingsReq_ByIds
	MergeScope    isMergeRecordingsReq_MergeScope `protobuf_oneof:"merge_scope"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MergeRecordingsReq) Reset() {
	*x = MergeRecordingsReq{}
	mi := &file_plugnmeet_auth_recording_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MergeRecordingsReq) Descriptor() ([]byte, []int) {
	return file_plugnmeet_auth_recording_proto_rawDescGZIP(), []int{14}
}

func (x *MergeRecordingsReq) GetMergeScope() isMergeRecordingsReq_MergeScope {
	if x != nil {
		return x.MergeScope
	}
	return nil
...
type isMergeRecordingsReq_MergeScope interface {
	isMergeRecordingsReq_MergeScope()
}
...
func (*MergeRecordingsReq_ByIds) isMergeRecordingsReq_MergeScope() {}
...
const file_plugnmeet_auth_recording_proto_rawDesc = "" +
	...
	"\rcom.plugnmeetB\x1bPlugnmeetAuthRecordingProtoP\x01Z2github.com/silentlamp/zenleader-protocol/plugnmeet\xa2\x02\x03PXX\xaa\x02\tPlugnmeet\xca\x02\tPlugnmeet\xe2\x02\x15Plugnmeet\\GPBMetadata\xea\x02\tPlugnmeetb\x06proto3"
...
var file_plugnmeet_auth_recording_proto_depIdxs = []int32{
	...
	16, // 2: plugnmeet.FetchRecordingsRes.status_code:type_name -> plugnmeet.StatusCode
	2,  // 3: plugnmeet.FetchRecordingsRes.result:type_name -> plugnmeet.FetchRecordingsResult
	16, // 4: plugnmeet.RecordingInfoRes.status_code:type_name -> plugnmeet.StatusCode
	1,  // 5: plugnmeet.RecordingInfoRes.recording_info:type_name -> plugnmeet.RecordingInfo
	17, // 6: plugnmeet.RecordingInfoRes.room_info:type_name -> plugnmeet.PastRoomInfo
	16, // 7: plugnmeet.DeleteRecordingRes.status_code:type_name -> plugnmeet.StatusCode
...
func file_plugnmeet_auth_recording_proto_init() {
	...
	file_plugnmeet_auth_recording_proto_msgTypes[14].OneofWrappers = []any{
		(*MergeRecordingsReq_BySession)(nil),
		(*MergeRecordingsReq_ByIds)(nil),
	}
	type x struct{}
